...
const logLevelThreshold: TrackerLogLevels = 'verbose';

if (logLevelThreshold === 'verbose') {
  console.warn(
    '[Uniform Tracker  verbose] Verbose logging enabled, update "logLevelThreshold" to reduce log output.'
  );
}
